...
/** Settings only for the passive bilingual subtitle overlay. */
final class SpanishStudySheet {
    ...
    static void show(Activity activity) {
        ...
        note.setText("v2.27 uses stock Morphe v1.41.0 for caption segmentation, OpenRouter/Mistral translation, seek handling, TTS rate, Edge synthesis, cache and prefetch. The study layer only paginates long subtitle text so it is not clipped.");
