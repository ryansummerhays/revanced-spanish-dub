...
public final class VideoSessionClock {
    ...
    /** Returns true only when this call creates a genuinely new content session. */
    ...
    /** Full player close. Reopening even the same id later is a fresh video epoch. */
    ...
    /**
     * Publish YouTube's current content position. This is the master measurement.
     * A large position jump begins a new continuity epoch. If an explicit seek was marked first,
     * that next position update consumes the marker and creates exactly one continuity boundary.
     */
    ...
    /** Marks a user/programmatic seek. The next video-time sample establishes the new continuity. */
