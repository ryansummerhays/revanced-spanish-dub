...
def main() -> None:
    ...
    require(gradle, 'implementation(files("libs/sherpa-onnx-1.13.7-classes.jar"))', "Sherpa compile API")
    ...
    print("READY gate, epoch invalidation, bounded capture, stride-4 containment and res/raw loading preserved")
