...
def main():
    ...
    # v2.21 added the low-thinking suffix. Normalize this text-only diagnostics anchor on the
    # v2.25 branch so the following release patch can replace it cleanly.
    rep(ctl,'report.append("speakerBackend=gemini-3.7-flash-youtube-agentic-audio-sidecar-low-thinking\\n");',
