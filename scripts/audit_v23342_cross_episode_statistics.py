...
EXPECTED = {
    "LiveSpeakerOnline.java": "0cd7704f09acf2769b46831a79af98f03b926022a2ecb6ecff97b63b61ae8c91",
...
def main():
    ...
    must(live, "if (ma.groups[i] == mb.groups[j]) continue", "same-group correlation exclusion")
