...
def main():
    ...
    req(sidecar, "MAX_EVENTS_PER_WINDOW = 700", "bounded full-timeline sample")
    req(sidecar, "valid.size() - 1.0", "uniform whole-video sampling")
    req(sidecar, "Math.min(60_000", "structured output token cap")
